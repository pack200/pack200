...
public class TestExceptions {
    ...
    static final File testJar = new File("target/test.jar");
    static final File testPackFile = new File("target/test.pack");
    ...
    public void init() {
        ...
        try {
            ...
            TestUtils.pack(jf, testPackFile);
    ...
    static abstract class TestInput {
        ...
        void close() {
            if (in != null && (in instanceof Closeable)) {
                TestUtils.close((Closeable) in);
            }
            if (out != null && (out instanceof Closeable)) {
                TestUtils.close((Closeable) out);
            }
        }
