...
public class MultiReleaseTest {
    private static final File cwd = new File("target");
    ...
    static abstract class TestCase {
        ...
        TestCase(String directory) throws IOException {
            ...
            TestUtils.createFile(manifestFile, scratch);
        }
        ...
        void run() throws Exception {
            emitClassFiles();
            // jar the file up
            File testFile = new File(tcwd, "test" + TestUtils.JAR_FILE_EXT);
            TestUtils.jar("cvfm",
                    ...
                    ".");
            File outFile = new File(tcwd, "test-repacked" + TestUtils.JAR_FILE_EXT);
            ...
            List<String> output = TestUtils.runExec(cmdsList);
            TestUtils.doCompareVerify(testFile.getAbsoluteFile(), outFile.getAbsoluteFile());
        }
    }
    ...
    static class TestCase1 extends TestCase {
        ...
        void emitClassFile(String version) throws IOException {
            ...
            final File srcFile = new File(srcDir, fname + TestUtils.JAVA_FILE_EXT);
            List<String> scratch = new ArrayList<>();
            ...
            TestUtils.createFile(srcFile, scratch);
            TestUtils.compiler("-d",
    ...
    static class TestCase2 extends TestCase {
        ...
        void emitClassFile(String version) throws IOException {
            ...
            final File srcFile1 = new File(srcDir, fname1 + TestUtils.JAVA_FILE_EXT);

            final String fname2 = "AbNormal";
            final File srcFile2 = new File(srcDir, fname2 + TestUtils.JAVA_FILE_EXT);
            switch (version) {
                case "8":
                    scratch.clear();
                    ...
                    scratch.add("}");
                    TestUtils.createFile(srcFile1, scratch);
                    break;
                default:
                    scratch.clear();
                    scratch.add("import java.io.IOException;");
            ...
            TestUtils.createFile(srcFile2, scratch);
            TestUtils.compiler("-d",
                    outDir.getAbsolutePath(),
