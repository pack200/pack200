...
public class TestUtils {
    ...
    static final File   TEST_SRC_DIR = new File("src/test/java");
    public static final File   TEST_CLS_DIR = new File("target/test-classes");

    private TestUtils() {} // all static

    static File getGoldenJar() {
        return new File("target/test-classes/data", "golden.jar");
    }
...
//        toDelete.addAll(TestUtils.findFiles(new File("."),
//                TestUtils.createFilter(".out")));
//        toDelete.addAll(TestUtils.findFiles(new File("."),
//                TestUtils.createFilter(".bak")));
//        toDelete.addAll(TestUtils.findFiles(new File("."),
//                TestUtils.createFilter(".jar")));
//        toDelete.addAll(TestUtils.findFiles(new File("."),
//                TestUtils.createFilter(".pack")));
//        toDelete.addAll(TestUtils.findFiles(new File("."),
//                TestUtils.createFilter(".bnd")));
//        toDelete.addAll(TestUtils.findFiles(new File("."),
//                TestUtils.createFilter(".txt")));
//        toDelete.addAll(TestUtils.findFiles(new File("."),
//                TestUtils.createFilter(".idx")));
//        toDelete.addAll(TestUtils.findFiles(new File("."),
//                TestUtils.createFilter(".gidx")));
//        toDelete.addAll(TestUtils.findFiles(new File("."),
//                TestUtils.createFilter(".tmp")));
//        toDelete.addAll(TestUtils.findFiles(new File("."),
//                TestUtils.createFilter(".class")));
//        for (File f : toDelete) {
//            f.delete();
//        }
    }
   ...
   static void createFile(File outFile, List<String> content) throws IOException {
    ...
    public static void jar(String... jargs) {
        List<String> cmdList = new ArrayList<>();
    ...
    public static void testWithRepack(File inFile, String... repackOpts) throws IOException {
        File cwd = inFile.getParentFile();
        // pack using --repack in native mode
        File nativejarFile = new File(cwd, "out-n" + TestUtils.JAR_FILE_EXT);
        ...
        File javajarFile = new File(cwd, "out-j" + TestUtils.JAR_FILE_EXT);
    ...
    static List<String> repack(File inFile, File outFile,
        ...
        List<String> cmdList = new ArrayList<>();
        cmdList.clear();
        cmdList.add(TestUtils.getJavaCmd());
        cmdList.add("-ea");
        cmdList.add("-esa");
        cmdList.add("-cp");
        cmdList.add("target/classes");
        if (disableNative) {
        ...
        return TestUtils.runExec(cmdList);
    }
